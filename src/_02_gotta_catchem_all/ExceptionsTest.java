...
class ExceptionsTest {
	...
	public void testDivideByZeroException() {
		try {
			assertEquals(ExceptionMethods.divide(5, 0), 0);
		} catch (IllegalArgumentException e) {
			System.out.println("Error");
		}
		assertEquals(ExceptionMethods.divide(5, 1),5);
	...
	public void testReverseString() {
		assertEquals(ExceptionMethods.reverseString("hello"),"olleh");
		
		try {
			assertEquals(ExceptionMethods.reverseString(""),"olleh");
